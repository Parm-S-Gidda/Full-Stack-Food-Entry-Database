 ...
 *     Data includes name, notes, price, expiry year, expiry month, and expiry day as well as if the item is a drink or food.
...
public class Consumable implements Comparable<Consumable> {
     ...
     */
    public String getConsumableNotes(){return consumableNotes;}

    /**
     *
     * @return double for item price
     */
    public double getConsumablePrice(){return consumablePrice;}
     ...
     */
    public long returnDaysTillExpire(){
    ...
    public int compareTo(Consumable compareItem){
        ...
        if(this.returnDaysTillExpire() == compareItem.returnDaysTillExpire()){
            return 0;
        } else if(this.returnDaysTillExpire() > compareItem.returnDaysTillExpire()){
            return 1;
        } else{
            return -1;
        }
